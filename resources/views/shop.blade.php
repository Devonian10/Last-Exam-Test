          ...
          <div class="card-body">
            ...
            <p class="card-text text-center">
              <form action="" method="post">
                @csrf
                <button type="submit"class="btn btn-primary text-lg-center" href="{{ url('/resipembayaran') }}"><i class="fa-solid fa-cart-plus" style="color: #FFFFFF "></i> Tambah keranjang</button>
            </form>
            </p>

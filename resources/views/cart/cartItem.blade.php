        ...
        <table class="table">
            <thead class="thead-primary">
                ...
                <tr class="text-center" id="removeCart-{{ $data->id }}">
                    <td class="product-remove"><button class="btn btn-primary p-2" onclick="removeCart({{ $data->id }})"><span class="icon-close"></span></button></td>
                    <td class="image-prod"><div class="img" 
                        style="background-image:url({{ asset('gambar/'.$data->product->image ) }});"></div>
                    </td>
                    ...
                    <td class="quantity">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="quantity-{{ $data->id }}" class="quantity form-control input-number" 
                            value="{{ $data->quantity }}" min="1" readonly>                            
                            <span class="input-group-btn">
...
<script>function reduceQuantity(itemId) {
